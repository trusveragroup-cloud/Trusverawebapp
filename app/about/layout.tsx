...
export const metadata: Metadata = {
  ...
  description:
    "TrusVera Group is a B2B technology marketing intelligence company. We deliver intent data, BANT-qualified leads, account profiling, and whitepaper promotion to enterprise technology companies. Founded 2019. Pune and Delaware.",
  keywords:
