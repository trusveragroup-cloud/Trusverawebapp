...
const STAT_PILLS = [
  { value: "150M+", label: "Buyer Profiles" },
  { value: "98%", label: "Data Accuracy" },
  { value: "45+", label: "Data Points Per Account" },
];
...
export default function AccountProfilingHero() {
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2 }}>
        ...
        >
          Know Every Account Before Your First Conversation
        </motion.h1>
        ...
        >
          TrusVera Group builds deep intelligence profiles on your target accounts, covering firmographics,
          technology stack, buying committee, and budget cycle, so your team walks into every conversation with
          an unfair advantage.
        </motion.p>
